...
class Eth extends AbstractMethods
{
    ...
    {
        $response = $this->send(
            $this->client->request(1, 'eth_getTransactionCount', [$address->toString(), $blockNumber->toString()])
        );
    ...
    {
        $response =$this->send(
            $this->client->request(1, 'eth_getLogs', [['address' => '0x0f01c2d1517c575d26e106753ab2f125a7c0c33d', 'from_block' => '15883270']])
        );
